...
<div class="container">
    ...
    <form method="POST" action="tenant-engine.php" enctype="multipart/form-data">
        ...
        <hr>
        <center><button id="submit" name="tenant_register" onclick="return Validate()">Register</button></center><br>
        <div class="form-group text-right">
            <label>Register as a <a href="owner-register.php">Owner</a>?</label><br>
        </div><br><br>
    </form>
</div>
