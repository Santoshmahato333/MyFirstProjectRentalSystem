...
$sql1="SELECT * FROM booking where tid='$tenant_id'  and (CURRENT_TIMESTAMP - start_date < 86400 )";
// echo $sql1; die;
...
<?php 
    ...
    echo '<h3 style="text-align: center"><b><i>You haven\'t booked any property! Or previous Bookings have been timed out! </i></b></h3>';
  }
