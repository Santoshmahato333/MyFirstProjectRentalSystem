...
<?php $sql2="SELECT * from property_photo where property_id='$property_id'";
    ...
    <div id="menu3" class="tab-pane fade">
      ...
      <?php 
        ...
        $count = 1;
        $sql="
        select booking.bid, tenant.full_name as booked_by, tenant.address as booker_address, tenant.phone_no as phone, add_property.province, add_property.district, add_property.zone, add_property.ward_no, owner.full_name as owner, owner.address as owner_address from booking join tenant on tenant.tenant_id  = booking.tid join add_property on add_property.property_id = booking.pid join owner on owner.owner_id = add_property.owner_id";
        $result=mysqli_query($db,$sql);
          ...
          while($ro=mysqli_fetch_assoc($result)){
            ...
            ?>
             ...
             <tr>
                  ...
                  <td><?php echo $ro['booked_by']; ?></td>
                  <td><?php echo $ro['booker_address']; ?></td>
                  ...
                  <td><?php echo $ro['owner_address']; ?></td>
                  <td><a onclick="confirm('Are you sure you want to delete the item?')" href="booking-delete.php?bid=<?php echo $ro['bid']; ?>">Delete</a>
                  </td>
                </tr>
              <?php }} ?>
              </table> 
